    ...
    public void onCreate(SQLiteDatabase db){
        ...
        try{
           ...
           for(int i=0; i<19; i++) {
            ...
            db.execSQL("create table Library(num INTEGER,name text,address text);");
            String[] library={"강원점자도서관","강원도장애인재활협회 복지문고","성남시한마음점자도서관","경기도시각장애인도서관","경기북부시각장애인 점자도서관","안양수리장애인종합복지관 시각장애인지원센터","소리작은도서관","경남점자정보도서관","대구대학교 점자도서관","경북점자도서관","광주점자도서관","대구점자도서관","대전점자도서관","부산점자도서관","마포점자도서실","강북점자도서실","한국점자도서관","한국시각장애인복지재단 점자도서관","실로암점자도서관","성동장애인종합복지관 홍보자료실","강서점자도서관","성북시각장애인복지관","산소망녹음도서관","하상점자도서관","종달새전화도서관","인성시각장애인도서관","서울점자도서관","서울시각장애인복지관 점자도서관","새날도서관","울산광역시점자도서관","송암점자도서관","전라남도시각장애인도서관","전남점자도서관","전북점자도서관","전북시각장애인도서관","제주도문화정보점자도서관","제주점자도서관","충남점자도서관","무지개도서관"};
            String[] address={"강원 춘천시","강원 춘천시","경기 성남시","경기 수원시","경기 의정부시","경기 안양시","경남 김해시","경남 창원시","경북 경산시","경북 포항시","광주 남구","대구 달서구","대전 동구","부산 사상구","서울 마포구","서울 강북구","서울 강동구","서울 강동구","서울 관악구","서울 성동구","서울 강서구","서울 성북구","서울 광진구","서울 강남구","서울 중구","서울 송파구","서울 노원구","서울 송파구","서울 광진구","울산 남구","인천 남구","전남 목포시","전남 목포시","전북 전주시","전북 전주시","제주 제주시","제주 제주시","충남 천안시","충북 청주시"};
