...
public class SupplementRuleActivity  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext=this;
        app_Dir=this.getFilesDir().getParent();
    ...
    private void CopyReadAssets()
    {
       ...
       /* Intent intent = new Intent(Intent.ACTION_VIEW);
        intent.setDataAndType(
                Uri.parse("file://" + getFilesDir() + "/brailleRule.pdf"),
                "application/pdf");
    ...
    public boolean exist(String srcFile){
        String destFile = SupplementRuleActivity.app_Dir + File.separator + srcFile;
    ...
    public void openPDF(String srcFile){
        String destFile = SupplementRuleActivity.app_Dir + File.separator + srcFile;
        File file = new File(destFile);
        if(file.exists()){
